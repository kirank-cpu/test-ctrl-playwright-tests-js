...
export class AddToCartFlowPage {
  constructor(page) {
    this.page = page;
    ...
    this.clickAddToCartLocatorBackpack = page.locator(`#add-to-cart-sauce-labs-backpack`);
    this.clickCartLocator = page.locator(`a.shopping_cart_link`);
    this.clickContinueShoppingLocator = page.locator(`#continue-shopping`);
    this.clickAddToCartLocatorBike = page.locator(`#add-to-cart-sauce-labs-bike-light`);
    this.click2Locator = page.locator(`a.shopping_cart_link`);
    ...
    this.clickRemoveLocatorbackpack = page.locator(`#remove-sauce-labs-backpack`);
    this.clickRemoveLocatorBike = page.locator(`#remove-sauce-labs-bike-light`);
    this.clickContinueShoppingLocator = page.locator(`#continue-shopping`);
  ...
  async clickAddToCartBackpack() {
    // Click "Add to cart"
    await this.clickAddToCartLocatorBackpack.click();
  }
  ...
  async clickAddToCartBike() {
    // Click "Add to cart" for bike
    await this.clickAddToCartLocatorBike.click();
  }
  ...
  async clickRemoveBike() {
    // Click "Remove"
    await this.clickRemoveLocatorBike.click();
  }

  async clickRemoveBackpack() {
    // Click "Remove"
    await this.clickRemoveLocatorbackpack.click();
  }
